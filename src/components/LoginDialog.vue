...
<template>
  <Dialog v-model:open="isOpen">
    ...
    <DialogContent class="sm:max-w-[500px]">
      <DialogHeader>
        <DialogTitle class="text-2xl font-bold text-center">Добро пожаловать</DialogTitle>
      </DialogHeader>
        ...
        <TabsContent value="login">
          <form @submit.prevent="login" class="space-y-4 mt-4">
            ...
            <div class="flex items-center justify-between text-sm">
              <a href="#" class="text-primary hover:underline">Забыли пароль?</a>
            </div>
      ...
      <div class="relative my-4">
        ...
        <div class="relative flex justify-center text-xs uppercase">
          <span class="bg-background px-2 text-muted-foreground"> или продолжить с </span>
        </div>
      </div>
